...
if CLIENT then
   ...
   SWEP.ViewModelFOV        = 54
	...
	SWEP.Description = "Kill from back. You can throw it."
end
...
function SWEP:StabKill(tr, spos, sdest)
   ...
   target.effect_fn = function(rag)
                         ...
                         rag:CallOnRemove("dm_knife_cleanup", function() SafeRemoveEntity(knife) end)
                      end
...
function SWEP:SecondaryAttack()
   ...
   if SERVER then
      ...
      local knife = ents.Create("dm_knife_proj")
