...
--Chat
l.ply_connected       = "Игрок {name} подключился к серверу."
l.ply_disconnected    = "Игрок {name} ({sid}) вышел с сервера."
...
l.purchase            = "Покупка"
l.sale                = "Продажа"
l.areusurepurchase    = "Вы уверены в покупке"
l.areusuresale        = "Вы уверены в продаже"
l.yes                 = "Да"
l.no                  = "Нет"