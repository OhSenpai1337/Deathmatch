...
net.Receive("RTV_Delay", function()
    chat.AddText(Color( 102,255,51 ), "[RTV]", Color( 255,255,255 ), " "..L["start_rtv"])
end)
...
function PANEL:Think()
    ...
    self.countDown:SetText(tostring(timeLeft or 0).." "..GetTranslation("seconds"))
